...
class FriendPattern:
    ...
    def record_hand(self, outcome: str, unit: float):
        ...
        # Star 2.0 progression reset on 2 wins
        if hit:
            self.total_hits += 1
            self.win_streak += 1
...
fig = go.Figure(data=[go.Table(
    ...
    cells=dict(values=values, fill_color="white", align="center")
)])
